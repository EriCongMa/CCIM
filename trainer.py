...
from task.train_interactive_decoding import interactive_decoding_train
...
if __name__ == '__main__':
    ...
    parser.add_argument('--FeatureExtraction', type=str, required=False, default='ResNet', help='FeatureExtraction stage.')
    ...
    parser.add_argument("--Weight_lambda", type = float, default = 0.3)
    ...
    if opt.task == "interactive_decoding":
        interactive_decoding_train(opt)
    else:
